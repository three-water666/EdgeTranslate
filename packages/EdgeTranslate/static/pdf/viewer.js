...
/******/ (() => {
    ...
    /******/ var __webpack_modules__ = [
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
            ...
            var _pdf_dark_mode = __webpack_require__(16);
            ...
            const PDFViewerApplication = {
                ...
                async _initializeViewerComponents() {
                    ...
                    const annotationEditorMode =
                        _app_options.AppOptions.get("annotationEditorMode");
                    const pageColors =
                    ...
                    this.pdfViewer = new _pdf_viewer.PDFViewer({
                        ...
                        findController,
                        scriptingManager:
                            _app_options.AppOptions.get("enableScripting") && pdfScriptingManager,
                    ...
                    this.darkMode = new _pdf_dark_mode.PDFDarkMode(
                        appConfig.toolbar.darkModeButton,
                        eventBus,
                        this.l10n
                    );
                    this.copyLink = new _pdf_copy_link.PDFCopyLink(
                ...
                setTitleUsingUrl(url = "", downloadUrl = null) {
                    ...
                    if (!title) {
                        try {
                            title =
                                decodeURIComponent((0, _pdfjsLib.getFilenameFromUrl)(url)) || url;
                        } catch (ex) {
                            title = url;
                        }
                    }
                ...
                copyLink() {
                    ...
                    try {
                        fileLink = window.location.href
                            .split("?")[1]
                            .split("&")
                            .find((param) => param.startsWith("file="))
                            .split("=")[1]
                            .split("#")[0];
...
`;
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
            ...
            const DIACRITICS_EXCEPTION = new Set([
                0x3099, 0x309a, 0x094d, 0x09cd, 0x0a4d, 0x0acd, 0x0b4d, 0x0bcd, 0x0c4d, 0x0ccd,
                0x0d3b, 0x0d3c, 0x0d4d, 0x0dca, 0x0e3a, 0x0eba, 0x0f84, 0x1039, 0x103a, 0x1714,
                0x1734, 0x17d2, 0x1a60, 0x1b44, 0x1baa, 0x1bab, 0x1bf2, 0x1bf3, 0x2d7f, 0xa806,
                0xa82c, 0xa8c4, 0xa953, 0xa9c0, 0xaaf6, 0xabed, 0x0c56, 0x0f71, 0x0f72, 0x0f7a,
        ...
        /***/ (__unused_webpack_module, exports) => {
            ...
            function isAsciiAlpha(charCode) {
                return (
                    (charCode >= 0x61 && charCode <= 0x7a) || (charCode >= 0x41 && charCode <= 0x5a)
                );
            }
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
            ...
            class PDFViewer {
                ...
                get isInPresentationMode() {
                    return (
                        this.presentationModeState === _ui_utils.PresentationModeState.FULLSCREEN
                    );
                }
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
            ...
            async function docPropertiesLookup(pdfDocument) {
                ...
                return {
                    ...
                    filename:
                        contentDispositionFilename || (0, _pdfjsLib.getPdfFilenameFromUrl)(url),
    ...
    (() => {
        ...
        var _pdf_link_service = __webpack_require__(7);
        var _app = __webpack_require__(2);
        const pdfjsVersion = "3.5.167";
        const pdfjsBuild = "cf66ef791";
        const AppConstants = {
        ...
        function getViewerConfiguration() {
            return {
                ...
                sidebar: {
                    ...
                    backButton: document.getElementById("sidebarBack"),
