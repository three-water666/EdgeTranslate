...
declare global {
  ...
  const detectSelect: typeof import('/Users/wangmiaoye/CODE/GITHUB/EdgeTranslate/packages/EdgeTranslate/components/common').detectSelect
  const fakeBrowser: typeof import('wxt/testing').fakeBrowser
  const injectScript: typeof import('wxt/utils/inject-script').injectScript
  const isChromePDFViewer: typeof import('/Users/wangmiaoye/CODE/GITHUB/EdgeTranslate/packages/EdgeTranslate/components/common').isChromePDFViewer
  const isPDF: typeof import('/Users/wangmiaoye/CODE/GITHUB/EdgeTranslate/packages/EdgeTranslate/components/common').isPDF
  const isPDFjsPDFViewer: typeof import('/Users/wangmiaoye/CODE/GITHUB/EdgeTranslate/packages/EdgeTranslate/components/common').isPDFjsPDFViewer
